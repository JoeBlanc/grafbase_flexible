    ...
    <footer className='flexStart footer'>
      <div className='flex flex-col gap-12 w-full'>
        <div className='flex flex-col items-start'>
          ...
          <p className='text-start font-normal text-sm mt-5 max-w-xs'>
            Flexible is the worls's leading community for creatives to share, grow, and get hired.
          </p>
        </div>
      ...
      <div className='flexBetween footer_copyright'>
        ...
        <p className='text-gray'>
          <span className='text-slate-900 font-semibold'>10,214</span> projects submitted
        </p>
      </div>
    </footer>
  )
